...
export default function edit_task_DOM(e) {
  ...
  info.innerHTML =
    `<form class="edit_form">Title <input type="text" name="title" id="title" placeholder="required" value="${task_edited.title || " "}">` +
    ...
    `Due_date <input type="date" name="due_date" id="due_date" placeholder="optional" value="${task_edited.due_date || " "}" min="${current_date}">` +
